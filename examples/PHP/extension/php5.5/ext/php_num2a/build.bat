SET PHP_SOURCE_PATH=d:\php-sdk\phpdev\vc11\x86\php-5.5.38-src
SET GLIB2_INCLUDE_PATH=D:\php-sdk\phpdev\vc11\x86\deps\include\glib-2.0
SET PHP_LIB_PATH=d:\xampp\php\dev\
SET NUM2A_LIB_PATH=j:\MyCodes\Helpers\c\num2a\
SET WIN_DEP_LIB_PATH=d:\php-sdk\phpdev\vc11\x86\deps\lib\\
